...
#define EFUSE_LL_HAS_PSRAM_ENCRYPTION_XTS_AES_256 (1)
    ...
    {
        return (efuse_ll_get_chip_wafer_version_major() * 100 + efuse_ll_get_chip_wafer_version_minor());
    }
    ...
    __attribute__((always_inline)) static inline bool efuse_ll_get_blk_version(void)
    {
