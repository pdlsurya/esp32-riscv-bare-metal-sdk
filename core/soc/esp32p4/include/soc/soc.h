...
// read value from 8 bit register
#define REG8_READ(_r) ({         \
    (*(volatile uint8_t *)(_r)); \
})
...
// get bit or get bits from 8 bit register
...
// set bit or set bits to 8 bit register
#define REG8_SET_BIT(_r, _b)                                            \
    do                                                                  \
    {                                                                   \
        *(volatile uint8_t *)(_r) = (*(volatile uint8_t *)(_r)) | (_b); \
    } while (0)
...
// clear bit or clear bits of 8 bit register
...
// set bits of 8 bit register controlled by mask
